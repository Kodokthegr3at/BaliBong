...
export class LanguageService {
  ...
  private readonly uiTranslations: Record<LanguageCode, Record<string, string>> = {
    id: {
      ...
      hero_desc: 'Rasakan kehangatan rempah otentik nusantara di setiap suapan hidangan khas Bali kami.',
    ...
    ja: {
      ...
      hero_desc: '本格的なスパイスの温もりを感じる、伝統的なバリ・インドネシア料理を一口ずつご堪能ください。',
    ...
    zh: {
      ...
      hero_desc: '在每一口巴厘岛特色美食中，感受印尼本土香料的醇厚温润。',
    ...
    ko: {
      ...
      hero_desc: '매 한 입마다 전해지는 정통 발리 향신료의 깊고 따뜻한 풍미를 맛보세요.',
    ...
    es: {
      ...
      hero_desc: 'Siente la calidez de las especias auténticas de Indonesia en cada bocado de nuestros platos tradicionales de Bali.',
