...
export class LanguageService {
  ...
  private readonly uiTranslations: Record<LanguageCode, Record<string, string>> = {
    id: {
      ...
      info_error: 'Informasi tidak tersedia saat ini.',
      menu_error: 'Menu tidak dapat dimuat saat ini. Silakan coba lagi.',
      retry_button: 'Coba Lagi',
      footer_tagline: 'Membawa cita rasa tradisional pulau Dewata Bali dan kelezatan hidangan Nusantara ke meja makan Anda.',
    ...
    ja: {
      ...
      loading: '読み込み中...',
      all_rights: '全著作権所有。',
      info_error: '現在、情報を取得できません。',
      menu_error: '現在メニューを読み込めません。もう一度お試しください。',
      retry_button: '再試行',
      footer_tagline: '伝統的なバリ島の味とヌサンタラ料理の美味しさを、あなたの食卓へ。',
    ...
    zh: {
      ...
      loading: '加载中...',
      all_rights: '版权所有。',
      info_error: '目前无法获取相关信息。',
      menu_error: '目前无法加载菜单，请重试。',
      retry_button: '重试',
      footer_tagline: '将巴厘岛的传统风味与努沙登加拉美食的美味带上您的餐桌。',
      footer_nav_title: '导航',
    ...
    ko: {
      ...
      loading: '불러오는 중...',
      all_rights: '모든 권리 보유.',
      info_error: '현재 정보를 가져올 수 없습니다.',
      menu_error: '현재 메뉴를 불러올 수 없습니다. 다시 시도해 주세요.',
      retry_button: '다시 시도',
      footer_tagline: '발리 섬의 전통적인 맛과 누산타라 요리의 풍미를 당신의 식탁으로.',
    ...
    es: {
      ...
      info_error: 'La información no está disponible en este momento.',
      menu_error: 'El menú no se pudo cargar en este momento. Inténtalo de nuevo.',
      retry_button: 'Reintentar',
      footer_tagline: 'Llevamos el sabor tradicional de la isla de Bali y los deliciosos platos de Indonesia a tu mesa.',
