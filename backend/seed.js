...
async function seed() {
  ...
  try {
    ...
    const catTranslations = [
      ...
      { category_id: 1, lang: 'en', name: 'Main Dishes' },
      ...
      { category_id: 2, lang: 'en', name: 'Vegetable Dishes' },
      ...
      { category_id: 4, lang: 'en', name: 'A la Carte' },
      ...
      { category_id: 5, lang: 'en', name: 'Recommended' },
      ...
      { category_id: 6, lang: 'en', name: 'Soft Drinks' },
      ...
      { category_id: 7, lang: 'en', name: 'Beer' },
      ...
      { category_id: 8, lang: 'en', name: 'Cocktails' },
    ...
    const menuRaw = [
      ...
      { cat: 1, name: 'Bali Bong Hamburg', price: 990, translations: { en: 'Bali Bong Hamburg Steak', ja: 'バリボン・ハンバーグ', zh: '巴厘岛汉堡肉排', ko: '발리 봉 함박스테이크', es: 'Hamburguesa Bali Bong' } },
      { cat: 1, name: 'Pho Goreng (Standard)', price: 1080, translations: { en: 'Fried Pho Noodles (Standard)', ja: '焼きフォー (並)', zh: '炒河粉 (标准)', ko: '볶음 쌀국수 (보통)', es: 'Fideos Pho Fritos (Estándar)' } },
      { cat: 1, name: 'Bali Bong Original Coconut Mapo Toufu', price: 990, translations: { en: 'Bali Bong Original Coconut Mapo Tofu', ja: 'バリボン特製ココナッツ麻婆豆腐', zh: '巴厘岛椰香麻婆豆腐', ko: '발리 봉 오리지널 코코넛 마파두부', es: 'Mapo Tofu de Coco Original' } },
      ...
      { cat: 1, name: 'Cumi-Cumi Goreng', price: 990, translations: { en: 'Fried Squid', ja: 'イカの唐揚げ', zh: '炸鱿鱼', ko: '오징어 튀김', es: 'Calamar Frito' } },
      { cat: 1, name: 'Gulai Kambing', price: 1300, translations: { en: 'Goat Curry (Gulai Kambing)', ja: 'ヤギ肉のカレー煮込み', zh: '咖喱羊肉', ko: '염소고기 굴라이 (카레)', es: 'Gulai de Cabra' } },
      ...
      { cat: 1, name: 'Maboroshi no Java Curry', price: 1080, translations: { en: 'Legendary Java Curry (Maboroshi)', ja: '幻のジャワカレー', zh: '幻之爪哇咖喱', ko: '환상의 자바 카레', es: 'Curry de Java de Ensueño' } },
      { cat: 1, name: 'Nasi Goreng', price: 1180, translations: { en: 'Fried Rice (Nasi Goreng)', ja: 'ナシゴレン', zh: '印尼炒饭', ko: '나시고랭', es: 'Arroz Frito (Nasi Goreng)' } },
      { cat: 1, name: 'Mie Goreng', price: 1180, translations: { en: 'Fried Noodles (Mie Goreng)', ja: 'ミーゴレン', zh: '印尼炒面', ko: '미고랭', es: 'Fideos Fritos (Mie Goreng)' } },
      { cat: 1, name: 'Bihun Goreng', price: 1180, translations: { en: 'Fried Rice Vermicelli (Bihun Goreng)', ja: 'ビーフンゴレン', zh: '炒米粉', ko: '비훈고랭', es: 'Bihun Frito' } },
      ...
      { cat: 1, name: 'Telor Balado', price: 990, translations: { en: 'Eggs in Chili Sauce (Telor Balado)', ja: 'ゆde卵のチリソース和え', zh: '辣酱鸡蛋', ko: '계란 발라도', es: 'Huevo Balado' } },
      { cat: 1, name: 'Tempe Manis', price: 750, translations: { en: 'Sweet Fried Tempeh', ja: '甘辛テンペ炒め', zh: '甜味印尼豆豉', ko: '달콤한 템페 볶음', es: 'Tempeh Dulce' } },
      { cat: 1, name: 'Tempe Laksa', price: 750, translations: { en: 'Tempeh Laksa', ja: 'テンペラクサ', zh: '印尼豆豉叻沙', ko: '템페 락사', es: 'Tempeh Laksa' } },
      { cat: 1, name: 'Udang Cah Terong', price: 680, translations: { en: 'Stir-Fried Shrimp with Eggplant', ja: 'エビとナスの炒め物', zh: '茄子炒虾', ko: '새우 가지 볶음', es: 'Camarones Salteados con Berenjena' } },
      { cat: 1, name: 'Tempe Goreng', price: 680, translations: { en: 'Fried Tempeh', ja: 'テンペの唐揚げ', zh: '炸印尼豆豉', ko: '템페 튀김', es: 'Tempeh Frito' } },
      { cat: 1, name: 'Perkedel Kentang', price: 680, translations: { en: 'Potato Croquette (Perkedel)', ja: 'インドネシア風ポテトコロッケ', zh: '马铃薯饼', ko: '인도네시아식 감자전', es: 'Croqueta de Patata' } },
      { cat: 1, name: 'Lumpia Goreng', price: 620, translations: { en: 'Fried Spring Rolls', ja: '揚げ春巻き', zh: '炸春卷', ko: '튀긴 춘권', es: 'Rollito de Primavera Frito' } },
      { cat: 1, name: 'Perkedel Jagung', price: 690, translations: { en: 'Corn Fritters (Perkedel Jagung)', ja: 'コーンかき揚げ', zh: '玉米饼', ko: '옥수수전', es: 'Buñuelo de Maíz' } },
      { cat: 1, name: 'Telor Dadar', price: 690, translations: { en: 'Indonesian Omelet', ja: 'インドネシア風オムレツ', zh: '煎蛋卷', ko: '인도네시아식 계란말이', es: 'Tortilla de Huevo' } },
      { cat: 1, name: 'Sate Ayam (4 tusuk)', price: 990, translations: { en: 'Chicken Satay (4 skewers)', ja: '焼き鳥 (4本)', zh: '鸡肉沙爹 (4串)', ko: '닭꼬치 (4꼬치)', es: 'Sate de Pollo (4 brochetas)' } },
      { cat: 1, name: 'Sate Ayam (2 tusuk)', price: 500, translations: { en: 'Chicken Satay (2 skewers)', ja: '焼き鳥 (2本)', zh: '鸡肉沙爹 (2串)', ko: '닭꼬치 (2꼬치)', es: 'Sate de Pollo (2 brochetas)' } },
      { cat: 1, name: 'Sate Kambing (4 tusuk)', price: 980, translations: { en: 'Goat Satay (4 skewers)', ja: 'ヤギ肉の串焼き (4本)', zh: '羊肉沙爹 (4串)', ko: '양꼬치 (4꼬치)', es: 'Sate de Cabra (4 brochetas)' } },
      { cat: 1, name: 'Sate Kambing (2 tusuk)', price: 500, translations: { en: 'Goat Satay (2 skewers)', ja: 'ヤギ肉の串焼き (2本)', zh: '羊肉沙爹 (2串)', ko: '양꼬치 (2꼬치)', es: 'Sate de Cabra (2 brochetas)' } },
      { cat: 1, name: 'Sate Lilit (4 tusuk)', price: 990, translations: { en: 'Sate Lilit (4 skewers)', ja: 'サテ・リリット (4本)', zh: '巴厘岛鱼肉沙爹 (4串)', ko: '사떼 릴릿 (4꼬치)', es: 'Sate Lilit (4 brochetas)' } },
      { cat: 1, name: 'Sate Lilit (2 tusuk)', price: 500, translations: { en: 'Sate Lilit (2 skewers)', ja: 'サテ・リリット (2本)', zh: '巴厘岛鱼肉沙爹 (2串)', ko: '사떼 릴릿 (2꼬치)', es: 'Sate Lilit (2 brochetas)' } },
      { cat: 1, name: 'Sate Campur (masing-masing jenis 2 tusuk, total 6 tusuk)', price: 1480, translations: { en: 'Mixed Satay (2 of each type, 6 skewers total)', ja: 'サテ盛り合わせ (6本)', zh: '混合沙爹 (共6串)', ko: '모듬 사떼 (총 6꼬치)', es: 'Sate Mixto (total 6 brochetas)' } },
      ...
      { cat: 1, name: 'Bakso', price: 1180, translations: { en: 'Meatball Soup (Bakso)', ja: 'バクソ (肉団子スープ)', zh: '肉丸汤', ko: '박소', es: 'Sopa de Albóndigas (Bakso)' } },
      { cat: 1, name: 'Mie Laksa', price: 1180, translations: { en: 'Laksa Noodles', ja: 'ミーラクサ', zh: '叻沙面', ko: '미 락사', es: 'Fideos Laksa' } },
      { cat: 1, name: 'Gaprao', price: 1080, translations: { en: 'Basil Pork Rice (Gaprao)', ja: 'ガパオライス', zh: '打抛猪肉饭', ko: '바질 돼지고기 덮밥', es: 'Arroz con Cerdo y Albahaca' } },
      ...
      { cat: 1, name: 'Udon Coconut Curry', price: 1080, translations: { en: 'Udon Coconut Curry', ja: 'ココナッツカレーうどん', zh: '椰香咖喱乌冬面', ko: '코코넛 카레 우동', es: 'Fideos Udon con Curry de Coco' } },
      { cat: 1, name: 'Pho Goreng (Spesial)', price: 1180, translations: { en: 'Fried Pho Noodles (Special)', ja: '焼きフォー (大/スペシャル)', zh: '炒河粉 (大份)', ko: '볶음 쌀국수 (스페셜)', es: 'Fideos Pho Fritos (Especial)' } },
      ...
      { cat: 1, name: 'Coconut Curry Pho', price: 1180, translations: { en: 'Coconut Curry Pho', ja: 'ココナッツカレーフォー', zh: '椰香咖喱河粉', ko: '코코넛 카레 포', es: 'Pho de Curry de Coco' } },
      { cat: 1, name: 'Tom Yum Pho', price: 1180, translations: { en: 'Tom Yum Pho', ja: 'トムヤムフォー', zh: '冬阴功河粉', ko: '똠얌 쌀국수 (포)', es: 'Pho Tom Yum' } },
      ...
      // Ala Carte
      { cat: 4, name: 'Udang Goreng Pedas', price: 680, translations: { en: 'Spicy Fried Shrimp', ja: 'エビのスパイシー唐揚げ', zh: '辣炸虾', ko: '매콤 새우 튀김', es: 'Camarones Fritos Picantes' } },
      ...
      { cat: 4, name: 'Mini Ayam Geprek', price: 690, translations: { en: 'Mini Ayam Geprek', ja: 'ミニ・アヤムゲプレック', zh: '迷你印尼碎辣炸鸡', ko: '미니 아얌 게프렉', es: 'Mini Pollo Smashed Picante' } },
      ...
      { cat: 4, name: 'Ikan Asam Manis', price: 580, translations: { en: 'Sweet and Sour Fish', ja: '魚の甘酢あんかけ', zh: '糖醋鱼', ko: '생선 탕수육', es: 'Pescado Agridulce' } },
      { cat: 4, name: 'Udang Laksa', price: 680, translations: { en: 'Shrimp Laksa', ja: 'エビのラクサ', zh: '虾肉叻沙', ko: '새우 락사', es: 'Camarones Laksa' } },
      ...
      // Rekomendasi
      { cat: 5, name: 'Nasi Campur', price: 1600, translations: { en: 'Nasi Campur (Mixed Rice Plate)', ja: 'ナシチャンプル', zh: '印尼什锦饭', ko: '나시 짬푸르', es: 'Nasi Campur (Arroz Mixto)' }, isRec: true },
      { cat: 5, name: 'Bali Bong Omurice', price: 1380, translations: { en: 'Bali Bong Omurice', ja: 'バリボン・オムライス', zh: '巴厘岛原创蛋包饭', ko: '발리 봉 오므라이스', es: 'Omurice Bali Bong' }, isRec: true },
      ...
      // Bir
      { cat: 7, name: 'Bintang Beer', price: 600, translations: { en: 'Bintang Beer', ja: 'ビンタンビール', zh: '星琥啤酒', ko: '빈탕 맥주', es: 'Cerveza Bintang' } },

      // Koktail
      { cat: 8, name: 'Arak Bali Attack', price: 800, translations: { en: 'Arak Bali Attack', ja: 'アラックバリアタック', zh: '巴厘岛米酒特调', ko: '아락 발리 어택', es: 'Arak Bali Attack' } }
    ];
